...
plot(make_lattice(length = 4, dim = 2,nei = 2,circular = F),main="Example of lattice which is not circular")
plot(make_lattice(length = 4, dim = 1,nei = 2,circular = T),main="Example of lattice which is circular")
