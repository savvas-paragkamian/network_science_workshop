...
erdos_renyi_parameters <- function(nodes,iterations,directed,loops,max_prob) {
  ...
  erdos_renyi_df <- data.frame(matrix(ncol = 8,nrow = iterations))
  colnames(erdos_renyi_df) <- c("nodes","giant_compontent_size","nclusters","probability","directed","loops","n_edges","mean_degree")
...
Measure of small-worldness [@Neal2017]
