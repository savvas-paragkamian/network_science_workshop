...
proteins_cluster <- Escherichia_coli_biogrid_physical_association_proteins
...
retrieveKGML("dme00190", organism="dme",destfile = "../Data/dme00190kegg.xml", method="wget", quiet=TRUE)
